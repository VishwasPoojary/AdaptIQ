...
const FILE_PATH = path.join(__dirname, 'dummy_test_node_fetch.txt');

async function testUpload() {
    console.log("🚀 Initiating local node-fetch upload integration test...");
    
    // Create a dummy test file
    fs.writeFileSync(FILE_PATH, "This is a brief file content to test the memory storage direct upload on localhost.");
